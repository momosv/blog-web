var Zepto = function () {
    ...
    var w, E, j, S, T, C, N = [], O = N.slice, P = N.filter, A = window.document, L = {}, Z = {},
        ...
        _ = /^\s*<(\w+|!)[^>]*>/, D = /^<(\w+)\s*\/?>(?:<\/\1>|)$/,
        R = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, M = /^(?:body|html)$/i,
        k = /([A-Z])/g, z = ["val", "css", "html", "text", "data", "width", "height", "offset"],
        F = ["after", "prepend", "before", "append"], q = A.createElement("table"), H = A.createElement("tr"),
        I = {tr: A.createElement("tbody"), tbody: q, thead: q, tfoot: q, td: H, th: H, "*": A.createElement("div")},
        V = /complete|loaded|interactive/, B = /^[\w-]*$/, U = {}, J = U.toString, X = {}, W = A.createElement("div"),
        Y = {
            tabindex: "tabIndex",
            readonly: "readOnly",
            "for": "htmlFor",
...
XIAOMI.namespace = function () {
    ...
    for (I = 0; I < f.length; I += 1) for (e = ("" + f[I]).split("."), r = XIAOMI, n = "XIAOMI" == e[0] ? 1 : 0; n < e.length; n += 1) r[e[n]] = r[e[n]] || {}, r = r[e[n]];
    return r
};
!function () {
    "use strict";
        ...
        return ("string" == typeof n ? n : n.toString()).replace(e.define || i, function (t, n, o, a) {
            ...
            e.useParams && (o = o.replace(e.useParams, function (e, t, n, o) {
                if (r[n] && r[n].arg && o) {
                    ...
                    return r.__exp = r.__exp || {}, r.__exp[a] = r[n].text.replace(new RegExp("(^|[^\\w$])" + r[n].arg + "([^\\w$])", "g"), "$1" + o + "$2"), t + "def.__exp['" + a + "']"
                }
            }));
    ...
    o.template = function (r, u, c) {
        ...
        f = ("var out='" + (u.strip ? f.replace(/(^|\r|\n)\t* +| +\t*(\r|\n|$)/g, " ").replace(/\r|\n|\t|\/\*[\s\S]*?\*\//g, "") : f).replace(/'|\\/g, "\\$&").replace(u.interpolate || i, function (e, t) {
            ...
            return "';" + n(t) + "out+='"
        }) + "';return out;").replace(/\n/g, "\\n").replace(/\t/g, "\\t").replace(/\r/g, "\\r").replace(/(\s|;|\}|^|\{)out\+='';/g, "$1").replace(/\+''/g, "").replace(/(\s|;|\}|^|\{)out\+=''\+/g, "$1out+="), s && u.selfcontained && (f = "String.prototype.encodeHTML=(" + e.toString() + "());" + f);
        try {
